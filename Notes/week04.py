...
# take a look at the formatting reference sheet (on canvas)
print(f'here\'s another example: {a:*^10.2f} and {b:#^20}')    #a will be centered with a width of 10 and have 2 decimals, b will be centered with a width of 20
print()
...
force = mass * accel
print(f"{force=}")  # cool trick to print variable=value. when you add the equal sign it prints the name of the variable, the equal sign, and the value 
...
# that I need to use? import math (see top of file)
x = 10 ** .5
print(x)
