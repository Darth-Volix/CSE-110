...
can_graduate = True  # should be True or False to be a boolean (those are boolean values)
...
#### can_graduate = None  # replace None with a condition (or complex condition). None means "nothing there" ######
can_graduate = credits >= 120 and gpa >= 2.0   # this is a complex condition 
print(can_graduate)
