...
11/28/2023
'''
# This version accomplishes stretch challenges 1 and 2
...
with open('books_and_chapters.txt') as file_var:
    ...
    for line in file_var:
        ...
        # Print the information for the Book of Mormon
        if scripture.lower() == 'book of mormon':
            print(f'Volume: {scripture}, Book: {book}, Chapters: {chapters}')

        # Find the book with the largest number of chapters in The Book of Mormon
        if scripture.lower() == 'book of mormon' and chapters > longest_book:
            longest_book = chapters
            longest_book_name = book
    
    # Output the result
    print(f'\nThe book with the longest number of chapters in the Book of Mormon is {longest_book_name}, which has {longest_book} chapters!\n')